$(document).ready(function(){
  $.ajax({
    ...
    .done(function(pokemon){
      ...
      $('#card').append(`<img src='${pokemon.imageUrl}' height='300px' style="margin-top: 100px;"> <br> <br> <br> <button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-danger" style="width: 225px;">Battle</button>`)
    })
    .fail(function(err){
